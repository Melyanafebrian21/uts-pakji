...
function App() {
  ...
  return (
    <>
      <Navbar />
      <Hero title="Cerita Menarik Untuk Anda." desc="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Neque recusandae et id adipisci. Dicta dolore officiis neque
